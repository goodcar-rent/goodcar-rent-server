...
export const userGroupAdd = (context, data, expectedCode) => context.request.post(`${context.apiRoot}/user-group`)
  .set('Authorization', `${context.authSchema} ${context.token}`)
  .send(data)
  .type('json')
  .accept('json')
...
export const userGroupItem = (context, groupId, expectedCode) => context.request.get(`${context.apiRoot}/user-group/${groupId}`)
  .set('Authorization', `${context.authSchema} ${context.token}`)
  .type('json')
  .accept('json')
  .expect(expectedCode || expected.Ok)

export const userGroupSave = (context, data, expectedCode) => context.request.put(`${context.apiRoot}/user-group/${data.id}`)
  .set('Authorization', `${context.authSchema} ${context.token}`)
  .send(data)
  .type('json')
  .accept('json')
...
export const userGroupDelete = (context, groupId, expectedCode) => context.request.delete(`${context.apiRoot}/user-group/${groupId}`)
  .set('Authorization', `${context.authSchema} ${context.token}`)
  .type('json')
  .accept('json')
  .expect(expectedCode || expected.Ok)
...
export const userList = (context, expectedCode) => context.request.get(`${context.apiRoot}/user`)
  .set('Authorization', `${context.authSchema} ${context.token}`)
  .type('json')
  .accept('json')
  .expect(expectedCode || expected.Ok)

export const userCreate = (context, data, expectedCode) => context.request.post(`${context.apiRoot}/user`)
  .set('Authorization', `${context.authSchema} ${context.token}`)
  .send(data)
  .type('json')
  .accept('json')
...
export const userItem = (context, userId, expectedCode) => context.request.get(`${context.apiRoot}/user/${userId}`)
  .set('Authorization', `${context.authSchema} ${context.token}`)
  .type('json')
  .accept('json')
  .expect(expectedCode || expected.Ok)

export const userSave = (context, userId, data, expectedCode) => context.request.put(`${context.apiRoot}/user/${userId}`)
  .set('Authorization', `${context.authSchema} ${context.token}`)
  .send(data)
  .type('json')
  .accept('json')
...
export const userDelete = (context, userId, expectedCode) => context.request.delete(`${context.apiRoot}/user/${userId}`)
  .set('Authorization', `${context.authSchema} ${context.token}`)
  .type('json')
  .accept('json')
  .expect(expectedCode || expected.Ok)
